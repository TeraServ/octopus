...
public class Job {
    ...
    public Job(long id, String title, String owner, String stage, String status, int activeCandidates, int droppedCandidates, int vacancy, String summary, String teamID, String endDate, LocalDateTime createdDate, LocalDateTime modifiedDate, Notification notification) {
        Id = id;
        this.title = title;
        this.owner = owner;
        this.stage = stage;
